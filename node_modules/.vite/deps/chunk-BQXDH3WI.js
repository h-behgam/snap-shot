...
var Offcanvas = React9.forwardRef(({
  ...
  const modalManager = (0, import_react6.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const {
    onToggle
  } = (0, import_react6.useContext)(NavbarContext_default) || {};
  const [showOffcanvas, setShowOffcanvas] = (0, import_react6.useState)(false);
  ...
  const modalContext = (0, import_react6.useMemo)(() => ({
    onHide: handleHide
  }), [handleHide]);
  ...
  const renderBackdrop = (0, import_react6.useCallback)((backdropProps) => (0, import_jsx_runtime9.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React10.forwardRef((props, ref) => {
  const context = (0, import_react7.useContext)(NavbarContext_default);
...
var Navbar = React12.forwardRef((props, ref) => {
  ...
  const handleCollapse = (0, import_react8.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react8.useMemo)(() => ({
...
//# sourceMappingURL=chunk-BQXDH3WI.js.map
